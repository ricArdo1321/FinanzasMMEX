...
class CanonicalTx:
    ...
    source_type: Literal['email', 'mp_api', 'scraping', 'ofx', 'csv', 'pdf', 'manual'] = 'email'
    ...
    # Tipología contable
    tx_type: Literal['purchase', 'bill_payment', 'transfer_in',
                     'transfer_out', 'internal_transfer',
                     'refund', 'cash_withdrawal', 'fee'] = 'purchase'
