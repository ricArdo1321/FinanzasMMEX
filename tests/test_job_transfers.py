...
def test_gmail_all_links_transfers_cross_source(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(finanzasmmex.adapters.be_email, "parse_purchase_email", _mock_be_parser)
    monkeypatch.setattr(finanzasmmex.adapters.mach_email, "parse_purchase_email", _mock_mach_parser)
