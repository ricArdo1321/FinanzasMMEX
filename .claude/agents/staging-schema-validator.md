...
description: Validates the staging.db schema and migrations. Use proactively when src/finanzasmmex/staging/schema.sql, repo.py, or any migration file is modified. Verifies versioning, indexes, constraints, and dry-runs the schema.
