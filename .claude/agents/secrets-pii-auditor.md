...
description: Scans for credential leaks and PII exposure across repo, fixtures, and logs. Use proactively before commits, before PRs, and whenever vault.py, adapters/*, tests/fixtures/*, or logs/ are modified. Mandates rotation of any leaked credential.
...
If `rotation_required: true` for any finding, list the rotation commands at the very top of the summary.
